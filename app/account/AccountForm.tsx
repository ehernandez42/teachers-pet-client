        ...
        <div className="flex flex-row min-h-screen justify-center items-center flex-col bg-gradient-to-b from-gray-900 to-gray-800 text-white space-y-4 md:space-y-6">
            ...
            <div>
                ...
                <input
                    id="fullName"
                    type="text"
                    className="ml-2 rounded p-2 text-black"
                    value={fullname || ''}
            ...
            <div>
                <button
                    className="bg-gray-600 hover:bg-gray-700 rounded-2xl p-2"
            ...
            <div>
                <form action="/auth/signout" method="post">
                    <button className="bg-gray-600 hover:bg-gray-700 rounded-2xl p-2" type="submit">
                        Sign out
                    </button>
                </form>
            </div>
