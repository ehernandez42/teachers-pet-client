    ...
    return (
        <div>
            {/* <form onSubmit={handleSubmit} id={"container"}
                ...
                <Textarea className={"text-black rounded-xl text-lg pb-10 m-auto bg-green-50"} value={textPrompt}
                          onChange={handleChange} id={"the body of text"}/>

                {isLoading ?
                    <button type={"submit"}
                            className={"w-full hover:bg-blue-400 p-2 text-center m-auto rounded-xl bg-blue-500"}>
                        <div role="status">
...
export default TranslateFromApi
